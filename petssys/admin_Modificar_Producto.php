...
<ul class="nav flex-column offset-2">
  ...
  <!--Tercer Botone-->
    ...
    <div class="col-sm-8 col-xs-8 col-md-7 offset-4 pt-2">      
            <div class="container-fluid">
              <h1 class="text-white display-5">Actualizar Producto</h1>
              <ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Actualizar Producto</li>
                       ...
                       <div class="card-header col-12">
                         <h3 class="text-left"><strong>Actualizar Producto</strong></h3>
                         <h4 class="text-left small text-muted">los campos seran modificados<em id="asterisco2">  </em> </h4>
...
<div class="col-8">
<input class="form-control"  type="text" disabled autofocus placeholder="455523525">
...
<div class="col-8">
<input class="form-control" type="text" disabled placeholder="Dog Chau">
</div>
</div>
<!--fin del primer input-->
<div class="form-group row">
...
<div class="col-8">
<input class="form-control" type="text" disabled placeholder="59">
</div>
</div>
<!--fin del primer input-->
<div class="form-group row">
<label class="col-4 col-form-label"><i id="asterisco"> </i>  Marca:</label>
<div class="col-8">
<select class="form-control" disabled>
<option>dog chaw</option>
<option>pro plan</option>
<option>oyal canin</option>
<option>kongo</option>
...
<div class="form-group row">
<label class="col-4 col-form-l
"><i id="asterisco"> * </i>Nombre proveedor:</label>
<div class="col-8">
<select class="form-control" >
<option selected hidden>seleccione opcion</option>
<option>1</option>
...
<div class="form-group row">
<label class="col-4 col-form-label custom-file">Imagen:</label>
<div class="col-8">
