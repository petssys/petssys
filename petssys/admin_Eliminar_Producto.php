...
<ul class="nav flex-column offset-2">
  ...
  <!--Tercer Botone-->
    ...
    <div class="col-sm-8 col-xs-8 col-md-7 offset-4 pt-2">      
            <div class="container-fluid">
              <h1 class="text-white display-5">Eliminar Producto</h1>
              <ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Eliminar Producto</li>
                       ...
                       <div class="card-header col-12">
                         <h3 class="text-left"><strong>Eliminar Producto</strong></h3>
...
<table class="table table-responsive">
  <thead>
    <tr>
      ...
      <th>Catidad del Producto</th>
      <th>Ubicaccion del Producto</th>
      <th>Ubicaccion Estante</th>
      <th>puntaje Producto</th>
