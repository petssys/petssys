                                        ...
                                        <div class="col-sm-8 col-xs-8 col-md-7 offset-4 pt-2">      
                                            <div class="container-fluid">
                                                ...
                                                <div class="card-header col-12">
                                                    <h3 class="text-left"><strong>Registro de Proveedores</strong></h3>
                                                    ...
                                                    <div class="col-12 col-md-12 col-xs-8">
                                                        <div class="form-group row pt-3">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Cod Proveedor:</label>
                                                            <div class="col-8">
                                                                <input class="form-control" type="text" autofocus placeholder="3532999" name="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Numero del Documento :</label>
                                                            <div class="col-8">
                                                                <input class="form-control" type="text" placeholder="8120987653" name="">
                                                            </div>
                                                        </div>
                                                        <!--fin del tercer input-->
                                                        <div class="form-group row">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Nombre del Proveedor :</label>
                                                            <div class="col-8">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Direccion :</label>
                                                            <div class="col-8">
                                                        ...
                                                        <!--fin del sexto input-->
                                                        <div class="form-group row">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Telefono Movil:</label>
                                                            <div class="col-8">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-4 col-form-label"><i id="asterisco"> * </i>Contacto:</label>
                                                            <div class="col-8">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-md-auto offset-sm-3">
                                                                <button type="submit" class="btn btn-primary" id="Crearprovee">Crear Proveedor</button> 
                                                            </div>
